...
def descarga_url_img(link):
   ...
   url_local = "/Users/1097499132/OneDrive/Documents/cuatrimestre/programacion concurrente/entrega de imagenes/{}.{}"
...
def subproceso():
   with ThreadPoolExecutor(max_workers=10) as executor:
      executor.map(descarga_url_img, listaImagen)
...
if __name__ == "__main__":
   ...
   print("Tiempo de descarga {}".format(timeit.Timer(subproceso).timeit(number=1)), "\n")
